...
function submitTemplateAction(form)
{
	var count = 0;
	for (var i=0;i<form.elements.length;i++)
	{
	...
	if(form.TemplateAction.value == 3 && count == 1){
    	return confirm("Would you like to delete this Template?");
	}
	
}

function submitCategoryAction(form)
{
	var count = 0;
	for (var i=0;i<form.elements.length;i++)
	{
	...
	if(form.CategoryAction.value == 3&& count == 1){
    	return confirm("Would you like to delete this website?");
	}
	
}
function submitWebpageAction(form)
{
	var count = 0;
	for (var i=0;i<form.elements.length;i++)
	{
	...
	if(form.WebpageAction.value == 3&& count == 1){
    	return confirm("Would you like to delete this webpage?");
	}
