<div class="positionsOfEquipments index">
	<h2>
	<?php __('Positions Of Equipments');?>
	</h2>
	<table cellpadding="0" cellspacing="0">
		...
		<tr <?php echo $class;?>>
			...
			<td class="actions"><?php echo $this->Html->link(__('View', true), array('action' => 'view', $positionsOfEquipment['PositionsOfEquipments']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $positionsOfEquipment['PositionsOfEquipments']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $positionsOfEquipment['PositionsOfEquipments']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $positionsOfEquipment['PositionsOfEquipments']['id'])); ?>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
