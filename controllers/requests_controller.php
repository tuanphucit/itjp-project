...
class RequestsController extends AppController {
    ...
    private function _check($roomid, $begin, $end) {
        $conditions = array(
            'Request.roomid' => (int) $roomid,
            //TODO : dk status
            'OR' => array(
                array(
                    'Request.begin_time >=' => $begin->format('Y-m-d H:i:s'),
                    'Request.begin_time <' => $end->format('Y-m-d H:i:s')
                ),
                array(
                    'Request.end_time >' => $begin->format('Y-m-d H:i:s'),
                    'Request.end_time <=' => $end->format('Y-m-d H:i:s')
                )
            )
        );
