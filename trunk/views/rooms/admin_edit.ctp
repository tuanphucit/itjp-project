...
$html->addCrumb(__('会議室編集', true), '/admin/rooms/edit');
?>
<div class="module width_full">
    <div class="module_header">
        <h3 style="width: 40%"><?php __('会議室編集') ?></h3>
	...
	//	echo $form->input('Image.image.remove',  array('type' => 'checkbox', 'label' => 'Delete Image'));
