...
<!--        <ul class="tabs">
            <li><?php echo $html->link(__('全部表示', true), array('controller' => 'PosOfEquips', 'action' => 'admin_index'), array('title' => __('全部表示', true))); ?></li>
        </ul>-->
    </div>
</div>
<table class="tablesorter" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            ...
            <th style="width: 10%" class="tableheader"><?php echo $this->Paginator->sort(__('コード', true), 'Equip.code'); ?></th>
            <th style="width: 20%" class="tableheader"><?php echo $this->Paginator->sort(__('名', true), 'Equip.name'); ?></th>
            ...
            <th style="width: 25%" class="tableheader"><?php echo $this->Paginator->sort(__('ノット', true), 'note'); ?></th>
