    ...
    <table class="tablesorter" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="width: 10%" class="tableheader"><?php echo $this->Paginator->sort(__('Customer', true), 'User.fullname'); ?></th>
                <th style="width: 15%" class="tableheader"><?php __('Total Time'); ?></th>
                <th style="width: 15%" class="tableheader"><?php __('Total Expense'); ?></th>
                <th style="width: 15%" class="tableheader"><?php __('Total Paid'); ?></th>
